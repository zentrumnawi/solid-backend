...
class Photograph(models.Model):
    ...
    img_original_scale = models.FloatField(verbose_name="scale", null=True, blank=True, help_text="Längeneinheit pro Pixel")
    
    img_alt = models.CharField(max_length=200)
    description = models.TextField(default="", blank=True, verbose_name="description (Markdown)")
    ...
    #location =
    date = models.DateField(null=True, blank=True, help_text="Datum der Lichtbildaufnahme")
