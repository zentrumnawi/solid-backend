# Generated by Django 3.0.9 on 2021-05-22 16:35
...
def migrate_Photograph_to_MediaObject(apps, schema_editor):
    ...
    # we need too loop over all Photographs
    ...
    for photo in Photograph.objects.all():
        ...
        # We can now happily delete the Photograph entry
        # photo.delete()
...
def migrate_MediaObject_to_Photograph(apps, schema_editor):
    ...
    # since there is no filterable backwards relation for `profile`
    for profile in SampleProfile.objects.all():
        ...
        # We can now happily delete the MediaObject entry
        # media_obj.delete()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("sample_content", "0009_remove_sampleprofile_systematics"),
    ]
