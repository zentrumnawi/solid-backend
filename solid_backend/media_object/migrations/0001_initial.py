    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', solid_backend.media_object.models.MediaObjectField(db_index=True, height_field='img_original_height', upload_to='media_object/', width_field='img_original_width')),
                ('img_original_width', models.PositiveSmallIntegerField(blank=True, editable=False, null=True, verbose_name='img width')),
                ('img_original_height', models.PositiveSmallIntegerField(blank=True, editable=False, null=True, verbose_name='img height')),
                ('img_original_scale', models.FloatField(blank=True, null=True, verbose_name='scale')),
