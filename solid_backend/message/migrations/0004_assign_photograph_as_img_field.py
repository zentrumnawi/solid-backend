...
def change_img_field(apps, schema_editor):
    ...
    for obj in Message.objects.exclude(Q(img_old="") | Q(img_old=None)):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RenameField(
            model_name="message", old_name="img", new_name="img_old",
        ),
        migrations.AddField(
            model_name="message",
            name="img",
        ...
        migrations.RemoveField(model_name="message", name="img_alt",),
        migrations.RemoveField(model_name="message", name="img_old",),
    ]
