...
def change_img_field(apps, schema_editor):
    ...
    """
    SlideshowImage = apps.get_model("slideshow", "SlideshowImage")
    Photograph = apps.get_model("photograph", "Photograph")

    for obj in SlideshowImage.objects.exclude(Q(img_old="") | Q(img_old=None)):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("slideshow", "0006_assign_photograph_as_img_field_slideshow_model"),
    ]

    operations = [
        migrations.RenameField(
            model_name="slideshowimage", old_name="img", new_name="img_old",
        ),
        migrations.AddField(
        ...
        migrations.RemoveField(model_name="slideshowimage", name="img_alt",),
        migrations.RemoveField(model_name="slideshowimage", name="img_old",),
    ]
